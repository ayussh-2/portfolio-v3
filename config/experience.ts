...
export const EXPERIENCE: ExperienceItem[] = [
  {
    ...
    details: [
      "Led a 30+ member chapter and 800+ member student community as Google Developer Group on Campus Lead at NIT Rourkela.",
      "Directed 4 shipped web projects — CREO, Zucchini, Yogurt, and Huckleberry — spanning conference, festival, and hackathon platforms.",
      "Organized HackNITR 7.0 in collaboration with OpenCode and TechSprint, a GDG-hosted hackathon.",
      "Ran technical sessions on cloud computing and AWS fundamentals, and led a MERN stack workshop series covering Node.js, Express, and MongoDB.",
    ],
    techStack: [
      "Leadership",
      "Community Building",
