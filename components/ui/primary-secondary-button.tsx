...
function PrimaryButton(
  props: Omit<PrimarySecondaryButtonProps, "variant">
) {
...
>(({ className, variant, asChild = false, children, ...props }, ref) => {
    ...
    return (
        <Comp
            ref={ref}
            className={cn(primarySecondaryButtonVariants({ variant, className }))}
            {...props}
        >
            <span aria-hidden="true" className={isPrimary ? primaryOverlay : secondaryOverlay}>
                {isPrimary ? (
                    <>
