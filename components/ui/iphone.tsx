            ...
            >
                <g mask={hasMedia ? "url(#screenPunch)" : undefined}>
                    <path
                        ...
                        className="fill-[#2a2a2a] dark:fill-[#404040]"
                    />
                    <path
                    ...
                    <path
                        ...
                        className="fill-[#2a2a2a] dark:fill-[#262626]"
                    />
                </g>
                ...
                <path
                    ...
                    className="fill-[#2a2a2a] stroke-[#2a2a2a] stroke-[0.5] dark:fill-[#404040] dark:stroke-[#404040]"
