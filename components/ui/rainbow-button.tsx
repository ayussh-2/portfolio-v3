        ...
        return (
            <Comp
                ...
                className={cn(
                    ...
                    disableRainbow &&
                        "animate-none before:hidden bg-none [background-image:none] [background-clip:padding-box] [background-origin:padding-box] bg-[length:auto] border border-input bg-background",
                )}
                ref={ref}
                {...props}
            />
