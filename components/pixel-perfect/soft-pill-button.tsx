        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <span
                        className={cn(
                            "absolute inset-0 transition duration-200 group-active:opacity-0 group-active:duration-[50ms]",
                            isPrimary
                                ? "opacity-[0.12]"
                    ...
                    <span
                        className={cn(
                            "absolute inset-0 transition duration-200 group-active:duration-[50ms]",
                            isPrimary
                                ? "opacity-[0.32]"
                    ...
                    <span
                        aria-hidden="true"
                        className={cn(
                            "absolute inset-0 rounded-[4px] p-px",
