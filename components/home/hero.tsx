        ...
        {dayUrl && nightUrl ? (
          <>
            <Image
              ...
              className={cn(
                "w-full h-full object-cover scale-150 block dark:hidden",
                imgClass,
              )}
              priority
            />
            <Image
              ...
              height={sizeConfig.px}
              className={cn(
                "w-full h-full object-cover scale-150 hidden dark:block",
                imgClass,
              )}
              priority
            />
  ...
  return (
    <section className="flex items-start justify-between w-full py-4 px-3">
      <div className="flex items-end justify-between gap-5">
        <Avatar dayUrl={DAY_AVATAR} nightUrl={NIGHT_AVATAR} />
        <div>
